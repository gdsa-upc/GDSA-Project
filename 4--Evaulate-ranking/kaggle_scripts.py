...
def rankings_csv(ann_val, ann_train,gt_file,random_file):
...
if __name__ == "__main__":
    ...
    #rootdir = sys.argv[0]
    rootdir = "/Users/Marta/Desktop/GDSA/TerrassaBuildings900/"
    ...
    rankings_csv(ann_val,ann_train,gt_file,random_file)
