...
def rank(params):
    ...
    fval= open((os.path.join(params['arrel_entrada'],params['bd_imatges'],'val','Features.txt')),'r')
    ftrain= open((os.path.join(params['arrel_entrada'],params['bd_imatges'],'train','Features.txt')),'r')
    #Obrim el fitxer de les annotation
    annotation=open((os.path.join(params['arrel_entrada'],params['bd_imatges'],'val','annotation.txt')),'r')
    ...
    for vkey in dval:
        ...
        if vkey not in lista_desconegut:
            ...
            frank = open((os.path.join(params['arrel_sortida'],params['bd_imatges'],'val','result',vkey+'.txt')),'w')
