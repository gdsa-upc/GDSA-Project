...
def evaluate_ranking():
    ...
    f.close() 
    ranks = os.listdir(params['arrel_entrada']+'/rankings/')  #llegeixo tots els noms dels fitxers del directori d'entrada i els guarda a ranks
    ...
    for r in ranks:
        ...
        if dic_gtv[R]!='desconegut':
            ...
            c=dic_gtv[R]
            f=open(params['arrel_entrada']+'/rankings/'+r)
            lines=f.read().split()
            f.close()
